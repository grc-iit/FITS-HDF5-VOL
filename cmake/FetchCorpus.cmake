...
set(SCIIO_CORPUS_DIR ${CMAKE_BINARY_DIR}/corpus)
file(MAKE_DIRECTORY ${SCIIO_CORPUS_DIR})
...
set(SCIIO_CORPUS_FILES "")
set(SCIIO_CORPUS_BEHAVIOR "")
foreach(spec ${SCIIO_CORPUS_SPEC})
    string(REPLACE "|" ";" parts ${spec})
    list(GET parts 0 fname)
    list(GET parts 1 sha_prefix)
    list(GET parts 2 behavior)

    set(target ${SCIIO_CORPUS_DIR}/${fname})
    ...
    list(APPEND SCIIO_CORPUS_FILES ${fname})
    list(APPEND SCIIO_CORPUS_BEHAVIOR ${behavior})
endforeach()

list(LENGTH SCIIO_CORPUS_FILES SCIIO_CORPUS_COUNT)
message(STATUS "Corpus: ${SCIIO_CORPUS_COUNT} file(s) available in ${SCIIO_CORPUS_DIR}")
